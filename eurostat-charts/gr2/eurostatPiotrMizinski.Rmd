...
Liczba samobójstw w Europie na 100 000 osób, w 2011 i 2015 roku, w przedziale wiekowym 15-19.
...
t2 <- get_eurostat(s1[4, "code"]) %>%  filter(age == "Y15-19", time == "2011-01-01")
...
left_join(lp, t2, by = c("geo" = "geo")) %>% 
  ...
  coord_map() + 
  ggtitle("Suicide death rate by age group 15-19, per 100 000 persons in 2011")
